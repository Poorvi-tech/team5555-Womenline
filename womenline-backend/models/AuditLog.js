...
// Method to log voice chatbot interaction
auditLogSchema.statics.logVoiceChatInteraction = async function (userId, interactionDetails) {
  const logEntry = new this({
    action: 'Voice Chat Interaction',
